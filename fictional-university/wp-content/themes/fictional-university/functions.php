...
function pageBanner($args = NULL) {
  ...
  // Initialize the $args array if it's not set
  if (!$args) {
    $args = array();
  }

  // Set default values only for missing keys
  $args = wp_parse_args($args, array(
    'title'    => isset($args['title']) ? $args['title'] : get_the_title(),
    'subtitle' => isset($args['subtitle']) ? $args['subtitle'] : get_field('page_banner_subtitle'),
    'photo'    => isset($args['photo']) ? $args['photo'] : (get_field('page_banner_background_image') ? get_field('page_banner_background_image')['sizes']['pageBanner'] : get_theme_file_uri('/images/ocean.jpg')),
  ));
  ?>
